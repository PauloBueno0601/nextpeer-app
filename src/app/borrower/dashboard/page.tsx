      ...
      <div className="fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-sm border-t border-border">
        <div className="flex items-center justify-around py-3 px-6">
          <button onClick={() => setActiveTab("emprestimos")} className="flex flex-col items-center space-y-1">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                activeTab === "emprestimos" ? "bg-accent/10" : ""
              }`}
            >
              <TrendingUp
                className={`w-5 h-5 ${activeTab === "emprestimos" ? "text-accent" : "text-muted-foreground"}`}
              />
            </div>
            <span
              className={`text-xs ${activeTab === "emprestimos" ? "text-accent font-medium" : "text-muted-foreground"}`}
            >
              Empréstimos
            </span>
          </button>
          ...
          <button onClick={() => setActiveTab("boletos")} className="flex flex-col items-center space-y-1">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                activeTab === "boletos" ? "bg-accent/10" : ""
              }`}
            >
              <FileText className={`w-5 h-5 ${activeTab === "boletos" ? "text-accent" : "text-muted-foreground"}`} />
            </div>
            <span
              className={`text-xs ${activeTab === "boletos" ? "text-accent font-medium" : "text-muted-foreground"}`}
            >
              Boletos
            </span>
          </button>
          ...
          <button onClick={() => setActiveTab("notificacoes")} className="flex flex-col items-center space-y-1">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                activeTab === "notificacoes" ? "bg-accent/10" : ""
              }`}
            >
              <BarChart3
                className={`w-5 h-5 ${activeTab === "notificacoes" ? "text-accent" : "text-muted-foreground"}`}
              />
            </div>
            <span
              className={`text-xs ${activeTab === "notificacoes" ? "text-accent font-medium" : "text-muted-foreground"}`}
            >
              Notificações
            </span>
          </button>
          ...
          <button onClick={() => setActiveTab("perfil")} className="flex flex-col items-center space-y-1">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                activeTab === "perfil" ? "bg-accent/10" : ""
              }`}
            >
              <User className={`w-5 h-5 ${activeTab === "perfil" ? "text-accent" : "text-muted-foreground"}`} />
            </div>
            <span className={`text-xs ${activeTab === "perfil" ? "text-accent font-medium" : "text-muted-foreground"}`}>
              Perfil
            </span>
          </button>
        </div>
